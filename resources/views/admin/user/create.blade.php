                            ...
                            <form action="{{ route('admin.user.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                           placeholder="Название" value="{{ (empty(old('name'))) ? '' : old('name') }}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role_fk" class="form-control" id="role">
                                        <option value="" disabled {{ (old('role_fk') == '') ? ' selected' : '' }}>Выберите роль</option>
                                        @foreach($user_roles AS $roleFk => $roleTitle)
                                            <option {{ (old('role_fk') == $roleFk) ? ' selected' : '' }} value="{{ $roleFk }}">
                                                {{ $roleTitle }}
                                            </option>
                                        @endforeach
                                    </select>
